                ...
                <div class="modal-footer" id="footer-modal-action">
                    <script>
                        function hapusPengguna(id, penulis) {
                            document.getElementById("isi-modal").innerHTML = 'Apakah anda yakin menghapus data <?= strtolower($page); ?> ' + penulis + ' ?';
                        ...
                        <?php foreach ($artikel as $data) : ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a class="btn btn-warning m-1" href="<?= base_url('artikel/'.$data->id.'/edit'); ?>">Edit</a>
